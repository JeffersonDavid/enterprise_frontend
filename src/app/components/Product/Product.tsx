...
export default function Product(initialType) {
  ...
  const handleImg = (simage:any) => { setSilderImg(simage)};
        ...
        <div className='prpcview secure-container flex justify-center items-center'>
                ...
                <div className="flex product_desc_width_he border border-gray-300 rounded p-2 w-[70%] h-[65%]">
                  ...
                  <div className="col2img w-3/10 p-1 flex flex-col justify-between m-auto h-full mr-2">
                    ...
                    <div>
                        <button className="mbbtnheart btnbcolor inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300" type="button" onClick={e => addTocart(e)}>
