...
<div className="bg-white border border-gray-200 rounded-lg shadow pr-cont">
    ...
    <div className="p-5">
        ...
        <Link href={props.data.source_page} className="mbbtnheart btnbcolor inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
            Mas información
